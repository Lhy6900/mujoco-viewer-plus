...
from utils.math_utils import (
    quat_conjugate, quat_mul, quat_invmul,
...
if __name__ == "__main__":
    ...
    xml_path = XML_PATH
    force_anchor_bodyname = FORCE_CONFIG['anchor_body']  # 从配置获取外力锚点
                ...
                if ghost_rendering_enabled:
                    for env_i in range(num_envs):
                        try:
                            ...
                            print('ghost 位置偏移:', base_pos_with_offset, '机器人位置:', dlist[env_i].qpos[:3])
