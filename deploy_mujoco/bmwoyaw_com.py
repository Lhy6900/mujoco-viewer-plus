...
def main():
    ...
    config = {
        ...
        'force_config': {
            ...
            'mode': {
                'stop': FORCE_CONFIG['mode']['stop'],    # 'fixtime' | 'keeping'
                'style': FORCE_CONFIG['mode']['style'],    # 'constant' | 'spring'
                'select': FORCE_CONFIG['mode']['select']           # None | 0 | 1 | [0, 2, 3]
            }
        },
